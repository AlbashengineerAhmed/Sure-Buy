      ...
      <div className='row align-items-center justify-content-between'>
        ...
        <div className="col-4 d-flex justify-content-end">
          <div className="toggle-view">
            <i className={`fas fa-2x p-2 fa-th ${viewType === 'grid' ? 'active text-success ' : 'text-secondary'}`} onClick={toggleViewType}></i>
            <i className={`fas fa-2x p-2 fa-list ${viewType === 'list' ? 'active text-success ' : 'text-secondary'}`} onClick={toggleViewType}></i>
          </div>
      </div>
